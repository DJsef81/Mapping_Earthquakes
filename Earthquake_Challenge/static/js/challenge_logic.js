...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
 ...
 function styleMajorInfo(feature) {
    return {
      ...
      color: "#000000",
      radius: getQuakeRadius(feature.properties.mag),
      stroke: true,
      weight: 0.5
    };
  }
 
  // 5. Change the color function to use three colors for the major earthquakes based on the magnitude of the earthquake. >5, >4, <4.
  ...
  function getQuakeRadius(magnitude) {
    if (magnitude === 0) {
      return 1;
    }
    return magnitude * 4;
...
// Create a style for the boundaries
let styleTech = {
  color: "green",
  weight: 3
}
